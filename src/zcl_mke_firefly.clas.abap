...
CLASS zcl_mke_firefly IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA commands_input TYPE string VALUE 'S1S2S3W4ME5E'.
    ...
    DO steps TIMES.
      ...
      ELSEIF command = commands-south.
        y = y + 1.
        IF y > 5.
          y = 1.
        ENDIF.

      ELSEIF command = commands-west.
        x = x - 1.
        IF x < 1.
          x = 5.
        ENDIF.

      ELSEIF command = commands-east.
        x = x + 1.
        IF x > 5.
          x = 1.
        ENDIF.

      ELSEIF command CA '0123456789'.
        firefly = command.
        CONTINUE.
